...
#### **ioet,** Loja, Ecuador — *Lider Técnico de un Equipo de Ingeniería de Lanzamiento y DevOps*
##### Marzo 2019 - PRESENTE
...
Consultor general para arreglar bugs y otros problemas (a nivel de base de datos), rol principal en el diseño final de la base de datos, desarrollo al nivel de base de datos con disparadores, procedemientos, integridad de datos y seguridad de aplicación para GOODAPPETIT.
...
Consultor general para arreglar bugs y otros problemas (a nivel de aplicación), rol prinicipal en el diseño general de componentes internos del la aplicación, desarrollo en autenticación, permisos, y sistemas de seguridad en adición a investigación y desarrollo para GOODAPPETIT.
...
Experiencia amplio en muchos areas de ciencias de la computación; análisis de sistemas, programación, inteligencia artificial y visión artificial, diseño de bases de datos y su administración, redes, computación parallela, gestión de proyectos y diseño de arquitectura de computadoras.
...
Un poco de experiencia en gestión de proyectos, especialmente con:
 - Estimaciones de Costo y Tiempo basados en Puntos de Funcción
...
Desarrollo en un sistema de reconocimiento y parsing de números en imágenes usando Python y OpenCV. El codigo se encuentra aquí: [GitHub](https://github.com/VAUTPL/Number_Detection)
